...
#
apr_builddir=/home/mbin96/build/src/term/httpd-2.0.63/srclib/apr
apr_builders=/home/mbin96/build/src/term/httpd-2.0.63/srclib/apr/build

# Some layouts require knowing what version we are at.
APR_MAJOR_VERSION=0
APR_DOTTED_VERSION=0.9.17
...
EXTRA_LDFLAGS=
EXTRA_LIBS=-lrt -lm -lcrypt -lnsl  -ldl
EXTRA_INCLUDES=
...
LINK         = $(LIBTOOL) $(LTFLAGS) --mode=link $(LT_LDFLAGS) $(COMPILE) -version-info 9:17:9 $(ALL_LDFLAGS) -o $@
