...
// void saveJpeg(unsigned char *buff, int imgBufferSize)
// {
//     __u_char pixel = 255;
...
int jpegCompress( unsigned char * inputBuffer, unsigned char ** outImgBuffer, unsigned long * outImgSize)
{
    //300kb = 300 * 1024
    //img size는 왠만하면 300 안넘음
    outImgBuffer[0] = (unsigned char *)calloc(300 * 1024, 1);
    *outImgSize = 300 * 1024;
   ...
   */
    ...
    jpeg_mem_dest(&cinfo, outImgBuffer, outImgSize);
   ...
   */
     ...
     */
        row_pointer[0] = &inputBuffer[cinfo.next_scanline * row_stride];
    ...
    // saveJpeg(imgBuffer[0], imgBufferSize);
